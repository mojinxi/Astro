...
description: 首先是flare要先安装docker，docker安装方法看
tags: [分享, 记录]
featured: false
draft: false
excerpt: 首先是flare要先安装docker，docker安装方法看我前面的文章记一次用Docker部署Aria2prosudoi切换到root用户mkdirrootdatadockerdataflarecd
