...
description: 前段时间在B站看到一个up主，搭建了个密码管理器Vaultw
tags: [记录]
featured: false
draft: false
excerpt: 前段时间在B站看到一个up主，搭建了个密码管理器Vaultwarden，缘由是他自己有个密码泄露，然后被撞库，steam账号被盗，微软账号被多地登录，被开了四台服务器，我就想着自己也搭建个，但是呢，我
