---
pubDatetime: 2021-07-23
title: 记一次用Docker部署Aria2-pro
slug: jiyiciyongdockerbushuaria2pro
description: 起因 我之前用aria2一直都是通过宝塔部署，无他，“简单”、文件清晰明了、文件好编辑等等。但我的vps硬盘很小，安装了宝塔空间就占用了23%，再用aria2下载文件，硬盘直接就爆了。在tg群里面，老哥们又说docker部署aria2pro很简单的，就一串代码的事，后续维护啥的都很方便，还能使用tg
tags:
- 随笔
featured: false
draft: false
